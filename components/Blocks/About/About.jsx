    ...
    return (
        <section className={styles.section}>
            <div className={styles.grid}>
                ...
                <header className={styles.header}>
                    ...
                    <TextReveal className={styles.description}>
                        I would describe myself as a creative web developer with over 1 years of experience in development.
                    </TextReveal>
                </header>
            ...
            <div className={styles.grid}>
                <header className={styles.header}>
                    <TextReveal className={styles.description}>
                        Currently, I live in Coimbatore. In my personal life, I love to travel with my backpack, watch documentaries about geography, and explore new traditional music.
                    </TextReveal>
                </header>
